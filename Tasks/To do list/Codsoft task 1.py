...
button=Button(frame,text="ADD",font="arial 20 bold",width=5,bg="purple",fg="#fff",bd=0,command=addTask)
...
listbox= Listbox(frame1,font=('arial',12),width=40,height=16,bg="light blue",fg="black",cursor="hand2",selectbackground="#5a95ff")
...
#edit
edit_label = Label(root, text="EDIT", font="arial 20", width=5, bg="purple", fg="white",bd=0, cursor="hand2")
edit_label.pack(side=RIGHT, pady=20)
edit_label.bind("<Button-1>", lambda event: editTask())

#delete
Delete_icon=PhotoImage(file="Image/delete.png")
Button(root,image=Delete_icon,bd=0,command=deleteTask).pack(side=LEFT,pady=13)
